...
else{$('#guest_span').html('');return true;}});$(".form-focus-trigger").click(function(e){e.preventDefault();window.scrollTo(0,document.getElementsByClassName("address")[0].offsetTop);if("#registration_primaryGuest_firstName"){$("#registration_primaryGuest_firstName").focus();}})})